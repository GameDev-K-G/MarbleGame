...
מציירים משולש על החול קובעים על כמה גולות לשחק כל שחקן שם את הכמות במשולש/עיגול לאחר מכן קובעים נקודת התחלה וכל שחקן בתורו זורק גולה במטרה להוציא גולות מן המשולש/עיגול כל גולה שהוציא זכה בה ויש לו תור נוסף מאותו המקום אם זרק את הגולה ונתקע במשולש במהלך המשחק חוזר לנקודת ההתחלה והתור של השחקן הבא אחריו.
 ...
 *קישור למשחק ב  :
[itch.io](https://gamedevk-g.itch.io/marblegame)
## תהנו :smiley:
</div>
